...
class strstr(simuvex.SimProcedure):
    ...
    def run(self, haystack_addr, needle_addr, haystack_strlen=None, needle_strlen=None):
        ...
        #additional code
        trace_data = ("strstr", {"haystack_addr": (haystack_addr, haystack_addr.symbolic), "needle_addr": (needle_addr, needle_addr.symbolic), "haystack_strlen": (haystack_strlen, haystack_strlen.symbolic), "needle_strlen": (needle_strlen, needle_strlen.symbolic)})
        try:
