...
class strtok_r(simuvex.SimProcedure):
    ...
    def run(self, str_ptr, delim_ptr, save_ptr, str_strlen=None, delim_strlen=None):
        ...
        #additional code
        trace_data = ("strtok_r", {"str_ptr": (str_ptr, str_ptr.symbolic), "delim_ptr": (delim_ptr, delim_ptr.symbolic), "save_ptr": (save_ptr, save_ptr.symbolic), "str_strlen": (str_strlen, str_strlen.symbolic), "delim_strlen": (delim_strlen, delim_strlen.symbolic)})
        try:
